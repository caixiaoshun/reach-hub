...
export const mockDatasets: (SegDataset | PanSharpeningDataset)[] = [
  {
    ...
    titleZh: '精细草地分割数据集',
    titleBo: 'འབྲུ་རིགས་བསྲེགས་པའི་གྲངས་ཐོའི་ཆ་ཚང།',
    ...
    shortDescriptionZh: '来自黄河源地区的高分辨率草地数据集，提供五个覆盖等级的精细标签以提高复杂地形的分割准确率。',
    shortDescriptionBo: 'གཙང་པོའི་ཐོན་ཁུངས་ས་ཁུལ་ནས་ཐོན་པའི་ཚད་གཞི་མཐོ་བའི་རྩྭ་ཐང་གི་གནས་ཚུལ་ཆ་ཚང་། ཁྱབ་ཁོངས་ལྔའི་མཚོན་རྟགས་བཀོད་ཡོད།',
    ...
    longDescriptionZh: '该数据集针对位于黄河源区生态敏感地带的玛多县高寒草地提供高质量、细粒度的标注。数据来源于2019年获取的8米分辨率高分二号和高分六号卫星影像，通过更精确的类别区分弥补现有公共数据集的不足。数据集包含1,500个图像-标注对（256×256像素），利用 X-AnyLabeling 工具标注并人工精修。按照国家生态调查标准，草地覆盖度分为由低到高的五个等级。该数据集专为高海拔、复杂地形环境下的草地分割设计，是遥感研究与环境监测的宝贵资源。'
    longDescriptionBo: 'གཞི་གྲངས་འདི་ གཙང་པོ་རྒྱལ་ཁབ་མ་དོ་རྫོང་གངས་རི་རྩྭ་ཐང་ལ་གཞི་ཟུར་དབྱེ་འབྱེད་ཡོད། 2019 ལོའི GF-2 དང GF-6 སྐར་མདའ་པར་རིས་སྐྱོང་བསྐུས་པ་ཡིན་པས་ གཞི་གྲངས་འདི་ 256×256 པིག་སེལ་གཉེར་བ་ 1,500 ཚོགས་ X-AnyLabeling ཆས་སྤྱོད་དེ་ལག་བསྐྱོད་གསར་བཟོས་ཡོད། རྩྭ་ཐང་ཁེར་དབྱེ་བ་ལྔ་པར་གཏོགས་ཡོད་པས་ མཐོ་སྒང་དང་ས་ཁོངས་རིང་བའི་སྐབས་ལ་རིག་ཞིབ་དང་ཡོ་བྱད་ལ་འདུལ་ཆེན་པོ་ཡོད།'
    ...
    tags: ["Grassland Segmentation", "Remote Sensing", "High-Resolution Satellite Imagery", "Gaofen-2", "Gaofen-6", "Yellow River Source", "Alpine Ecosystem", "Fine-Grained Labels", "Ecological Monitoring", "Land Cover Classification"],
  tagsZh: ["草地细分", "遥感", "高分辨率卫星图像", "高芬-2", "高芬-6", "黄河源", "高山生态系统", "细粒标签", "生态监测", "土地覆盖分类"],
  tagsBo: ["རྩྭ་སའི་དབྱེ་འབྱེད།", "ཐག་རིང་ཚོར་སྣང་།", "གསལ་ཚད་མཐོ་བའི་སྐར་མདའ་པར་རིས།", "གྷོ་ཧྥེན་-༢།", "གྷོ་ཧྥེན་-༦", "གཙང་པོ་སེར་པོའི་ཡོང་ཁུངས།", "སྐྱེ་ཁམས་དཔལ་འབྱོར།", "ལེགས་སྦྱར་གྱི་མིང་བྱང་།", "སྐྱེ་ཁམས་ལྟ་རྟོག།", "ས་ཞིང་ཁེབས་པའི་དབྱེ་འབྱེད།"],
  ...
  //   titleZh: '精细云分割',
  //   titleBo: 'ལེགས་པར་བརྩམ་པའི་སྤྲིན་པའི་དབྱེ་བ།',
  ...
  //   shortDescriptionZh: '一个带有像素级云注释的精选 Landsat 8 数据集，旨在在不同地形和生物群落中实现精细云分割。',
  //   shortDescriptionBo: 'ལེནཌ་སེ་ཊི་༨ ཡི་གནས་ཚུལ་འཛུལ་དུ་བསྡུ་རྒྱས་བྱས་པའི་འཇུག་སྤྲིན་ཐོག་གི་མཚོན་བྱས་ཀྱི་དབྱེ་བ་འགྲིག་མཚམས་ཀྱི་ལྟོགས་པ་ཐེབས་ཀྱི་དགོས་མཁོ་བསྒོར་བཟོས་པ།',
  ...
  //   tags: ["Cloud Segmentation", "Remote Sensing", "Landsat 8", "Pixel-Level Annotation", "Multispectral Imagery", "Cloud Detection", "Cloud Shadow", "Thin Cloud Recognition", "Terrain-Corrected Scenes"],
  // tagsZh: ["云细分", "遥感", "Landsat 8", "像素级注释", "多光谱图像", "云检测", "云阴影", "细云识别", "地形校正的场景"],
  // tagsBo: ["སྤྲིན་པའི་དབྱེ་བ།", "ཐག་རིང་ཚོར་སྣང་།", "Landastat 8", "པིག་སེལ-རིམ་པའི་མཚན་ཉིད་མེད་པ།", "སྤྱིར་ན་སྣ་མང་པར་རིས།", "སྤྲིན་རྟོག་ཤེས་པ།", "སྤྲིན་གྱིབ་མ།", "ཐིན་སྤྲིན་གྱི་ངོས་འཛིན།", "ས་བབ་བཅོས་སྒྲིག་བྱས་པའི་ཡུལ་ལྗོངས།"],
  ...
  // } as SegDataset,
  {
    ...
    titleZh: 'PanBench 数据集',
    titleBo: 'PanBench གཞི་གྲངས་ཆ་ཚན།',
    ...
    shortDescriptionZh: 'PanBench 是一个大规模的 Pansharpening 数据集，由 5,898 对多光谱和全色遥感图像组成，经过预处理和裁剪，可高效训练模型并覆盖六类地物场景。',
    shortDescriptionBo: 'པན་བྷེན་ཆི་ གཞི་གྲངས་ཆེན་པོ་ཞིག་ཡིན་པས་ 5,898 ཚོད་མཚམས་མཐའ་བསྐྲུན་གྱི་མཚོན་རིས་དང་པན་ཀོ་རོ་མེ་ཊིག་ཡིག་སྣ་ཚོགས་སྔོན་བཟོས་དང་བཤུད་པས་ས་ཆ་དྲུག་གི་ལྟོགས་པའི་སྣ་ཚོགས་ལ་གྲོགས་རོགས་བྱེད་པ།',
    ...
    longDescriptionZh: 'PanBench 是一个用于 Pansharpening 任务的综合数据集，包含 5,898 对高质量遥感图像。每对样本由 256×256 分辨率的四通道多光谱图像（RGB + 近红外）和 1024×1024 分辨率的单通道全色图像组成。为提升数据处理效率，原始大幅遥感影像经过辐射校正、大气和正射校正以及图像配准等预处理后被切割成小块，既降低了计算成本又保留了关键的空间与光谱信息。相较于 GPPNN、PanNet、PGCU 等模型使用的数据集，PanBench 具有更大的切片尺度，可使模型在多场景下具有更好的泛化能力。它同时支持不同空间分辨率的传感器，如 LC7/LC8 的 2 倍下采样和 WV-2/WV-3 的 4 倍下采样，并将多光谱输入统一为四个主要波段（R、G、B、NIR），以保证跨传感器的一致性。此外，PanBench 根据 DeepGlobe 和 Cheng 等参考数据标记了场景类别（如水域、城市、冰雪、农作物、植被和裸地），适用于城市规划、土地管理和灾害响应等多样化应用场景的稳健评估。'
    longDescriptionBo: 'PanBench ནི pansharpening ལས་དགོས་གཞིའི་གཞི་གྲངས་ཆེན་པོ་ཞིག་ཡིན། 5,898 གཉེར་བའི་རིས་པར་འདུས་ཡོད་པས་ 256×256 ཁྲོད་ཚད་ཀྱི་མིག་སྣ་བཞི་དང 1024×1024 ཚད་ཀྱི་ཕན་རོགས་མིག་གཅིག་གི་ལས་མཐར་འདུལ་ཡོད། དབྱེ་མཚམས་གཞི་རིགས་དེ་སྤྱིར་བཟོས་ཡོད་པས་ གཙུག་གི་གཞི་རིམ་དང་གནད་དོན་ཉམས་མྱོང་མང་པོ་སུམ་དུ་བསྡུས་ཡོད།'
    ...
    tags: ["pansharpening", "remote sensing", "multispectral", "panchromatic", "satellite imagery", "land cover classification", "image fusion", "high-resolution", "geospatial data", "earth observation"],
  tagsZh: ["Pansharpening", "遥感", "多光谱", "全色", "卫星图像", "土地覆盖分类", "图像融合", "高分辨率", "地理空间数据", "地球观察"],
  tagsBo: ["པན་ཤར་པེན།", "ཐག་རིང་ཚོར་ཤེས་ཅན།", "མིག་མང་མང་པོ།", "པན་ཊོ་རིགས།", "སྐར་མདའ་པར་རིས།", "ས་ཞིང་ཁེབས་པའི་དབྱེ་འབྱེད།", "པར་རིས་མཉམ་བསྲེས་བྱེད་པ།", "ཚད་མཐོའི་གསལ་བསྒྲགས།", "ས་གཤིས་གནས་ཚུལ།", "ས་གཞི་ལྟ་ཞིབ།"],
